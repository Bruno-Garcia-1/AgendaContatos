...
<!-- jQuery 3.6.0 -->
<script src="{{ asset('/libs/jQuery/jquery-3.6.0.min.js') }}" type="text/javascript"></script>

<!-- jQuery Mask 1.7.7 -->
<script src="{{ asset('/libs/jQuery/jquery.mask-1.7.7.min.js') }}" type="text/javascript"></script>
